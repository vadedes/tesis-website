...
function tesis_files(){
    ...
    // wp_enqueue_script('tesis-webflow-scripts', get_theme_file_uri('/js/webflow.js'), array('jquery'), 1.0, true);
    ...
    wp_enqueue_style('webflow_styles', get_theme_file_uri('/build/index.css'));
}
